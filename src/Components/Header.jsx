  ...
  return (
    <header className="container mx-auto md:flex justify-between max-width">
      <div className="flex justify-between items-center">
        <NavLink to="/">
          <img className="w-[200px] h-auto" src={logos.logogradient} alt="logo" />
        </NavLink>
      ...
      <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
        <ul className="dark:text-light-content font-medium md:flex items-center md:space-x-5 md:mr-10">
          <li className="pb-1 md:pb-0">
            <NavLink end to="/" onClick={toggleClass}>
              Home
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0">
            <NavLink end to="/about" onClick={toggleClass}>
              About
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0">
            <NavLink end to="/technologies" onClick={toggleClass}>
              Technologies
            </NavLink>
          </li>
          <li className="pb-1  md:pb-0">
            <NavLink end to="/projects" onClick={toggleClass}>
              Projects
            </NavLink>
          </li>
          <li>
            <NavLink end to="/contact" onClick={toggleClass}>
              Contact
            </NavLink>
          </li>
        </ul>
